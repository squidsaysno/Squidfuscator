...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        let embed = new MessageEmbed()
            .setTitle("Squidfuscator")
            .setDescription("Obfuscation Settings")
            ...
            message.channel.awaitMessages(filterMessage, { max: 1, time: 30000, errors: ['time'] })
                .then(collected => {
                    ...
                    if(attachment) {
                        ...
                        let yesyesembed = new MessageEmbed().setTitle("Squidfuscator").setDescription("Obfuscating...").setColor(Colors.lightblue)
                        msg.edit(yesyesembed).then(lmao => {
                            ...
                            setTimeout(() => {
                                ...
                                lmao.edit(new MessageEmbed().setTitle("Squidfuscator").setDescription("Done!").setColor(Colors.lightblue))
                            }, 5000);
